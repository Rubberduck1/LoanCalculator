...
class LoanCalculator:
    def __init__(self):   #Special method in Python Class-Constructor of a Python Class
        ...
        Label(window, font='Helvetica 12 bold', bg='light green', text='Annual Interest Rate in %').grid(row=1, column=1, sticky=W)
    ...
    def computePayment(self):
        monthlyPayment = self.getMonthlyPayment( # within the method the following floats are variables
